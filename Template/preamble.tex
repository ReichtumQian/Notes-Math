...
\definecolor{myexercisebg}{HTML}{FFF5F0}  % 浅橙色背景
\definecolor{myexercisefr}{HTML}{FFC280}  % 中等橙色边框
\definecolor{myexerciseti}{HTML}{B35C00}  % 深橙色标题
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[use counter from=theorem, number within=section]{proposition}{Proposition}
{%
	enhanced
	,breakable
	,colback = myg!10
...
{%
	...
	,breakable
	,colframe = myexercisefr
	,coltitle = myexerciseti
	,boxrule = 1pt
	,sharp corners
	,detach title
	,before upper=\tcbtitle\par\smallskip
